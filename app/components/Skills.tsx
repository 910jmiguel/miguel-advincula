...
const Skills = () => {
  ...
  const SkillCard = ({ skill }: { skill: Skill }) => (
    <div className="group bg-white p-6 rounded-xl border border-stone-200 card-lift cursor-default">
  ...
  return (
    <section id="skills" className="py-16 md:py-24 bg-stone-50 grain relative">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex justify-center mb-12">
          <div className="bg-white rounded-full p-1 border border-stone-200 shadow-sm">
            <button
              ...
              style={activeTab === "technical" ? { background: 'var(--copper)' } : {}}
            >
              Technical Skills
            </button>
            <button
              ...
              style={activeTab === "soft" ? { background: 'var(--copper)' } : {}}
            >
              Soft Skills
            </button>
          </div>
        ...
        <div ref={contentRef} className="reveal">
          ...
          {activeTab === "technical" && (
            <div className="space-y-12">
              {skillCategories.map((category: SkillCategory, idx: number) => (
                ...
                >
                  <h3 className="font-display text-2xl font-bold mb-6 text-center text-stone-700">
                    {category.title}
                  </h3>
          ...
          {activeTab === "soft" && (
            <div className="animate-fade-in">
              <h3 className="font-display text-2xl font-bold mb-8 text-center text-stone-700">
